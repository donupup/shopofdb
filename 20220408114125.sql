...
MySQL Backup
Database: shop2
Backup Time: 2022-04-08 11:41:25
*/
...
CREATE TABLE `bms_good_out` (
  ...
  `good_id` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_id` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `num` int DEFAULT NULL,
  `good_out_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
